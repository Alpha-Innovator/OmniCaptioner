...
from dataset.processing_qwen2_vl import Qwen2VLProcessor
from model.qwen2_vl import Qwen2VLForConditionalGeneration
from trainer import QwenTrainer
from dataset.data_multi_v_addsys_addcache import make_supervised_data_module
...
from dist_util import init_dist
...
def train():
    ...
    processor = Qwen2VLProcessor.from_pretrained(model_args.model_id,
                                              padding_side="right",
